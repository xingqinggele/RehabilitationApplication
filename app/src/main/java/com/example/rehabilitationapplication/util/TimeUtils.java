...
public class TimeUtils {
    ...
    //获取当前前几天
    public static String getClander(int day){
    ...
    public static String getCerTime(Date date) {//可根据需要自行截取数据显示
     ...
     public static String getSelectCerTime(Date date) {//可根据需要自行截取数据显示
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        return format.format(date);
    }
    ...
    public static String getNewTimes1(Date date) {//可根据需要自行截取数据显示
        SimpleDateFormat format = new SimpleDateFormat("yyMM");
        return format.format(date);
    }
    /**
